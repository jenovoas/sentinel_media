...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView }) => {
    // Balancer logic removed - Single Host (Fenix)
    const menuItems = [
                ...
                <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/5 space-y-4">
                    ...
                    <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <Globe size={12} className="text-sentinel-blue" />
                            <span className="text-[8px] font-black uppercase tracking-widest text-white/40">HOST</span>
                        </div>
                        <span className="text-[8px] font-mono font-bold text-sentinel-blue">
                            FENIX-LOCAL
                        </span>
                    </div>
                </div>
